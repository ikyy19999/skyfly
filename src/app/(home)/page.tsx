...
export default async function HomePage() {
	...
	return (
		<>
			<section
				id="Header"
				className="bg-[url('/assets/background/airplane.jpg')] bg-no-repeat bg-cover bg-left-top -z-10"
			>
								...
								<div className="flex flex-col justify-center gap-[14px]">
									...
									<div className="flex gap-[10px]">
										...
										<select
											name="departure"
											id="departure"
											className="font-semibold text-[22px] leading-[26.63px] appearance-none bg-[url(/assets/icons/arrow-down.svg)] bg-no-repeat bg-[right_1px] pr-[30px]"
										>
					...
					<div className="flex flex-col gap-[30px] w-[220px]">
						<div className="flex shrink-0 w-[70px] h-[70px] rounded-full items-center justify-center bg-flysha-light-purple">
							<Image
								width={35}
								height={35}
								src="/assets/icons/building-3.svg"
								alt="icon"
							/>
						</div>
						<div className="flex flex-col gap-1">
					...
					<div className="flex flex-col gap-5">
						<div className="rounded-[30px] h-[310px] overflow-hidden">
							<Image
								width={40}
								height={40}
								src="/assets/thumbnail/thumbnail1.png"
						...
						<div className="flex gap-[14px] items-center">
							<div className="flex shrink-0 w-8 h-8">
								<Image
									width={40}
									height={40}
									src="/assets/icons/crown-white.svg"
									className="w-8 h-8"
									alt="icon"
								/>
							</div>
					...
					<div className="flex flex-col gap-5">
						<div className="rounded-[30px] h-[310px] overflow-hidden">
							<Image
								width={40}
								height={40}
								src="/assets/thumbnail/thumbnail2.png"
								className="w-full h-[310px] object-cover"
								alt="thumbnail"
							/>
						</div>
					...
					<div className="flex flex-col gap-5">
						<div className="rounded-[30px] h-[310px] overflow-hidden">
							<Image
								width={40}
								height={40}
								src="/assets/thumbnail/thumbnail3.png"
								className="w-full h-[310px] object-cover"
								alt="thumbnail"
							/>
						</div>
					...
					<div className="flex flex-col gap-5">
						<div className="rounded-[30px] h-[310px] overflow-hidden">
							<Image
								width={40}
								height={40}
								src="/assets/thumbnail/thumbnail4.png"
								className="w-full h-[310px] object-cover"
								alt="thumbnail"
							/>
						</div>
								...
								<div className="flex gap-4 items-center">
									<div className="flex shrink-0 rounded-full w-[50px] h-[50px] overflow-hidden">
										<Image
											width={30}
											height={30}
											src="/assets/photos/Group 47.png"
			...
			<footer className="flex flex-col justify-between mt-[150px] border-t-[6px] border-flysha-light-purple p-[100px_10px_30px]">
				<div className="container max-w-[1130px] mx-auto flex justify-between relative">
					<Image
						width={300}
						height={300}
						src="/assets/icons/Ellipse 4.png"
						...
						<div className="flex flex-col gap-5">
							...
							>
								<Image
									...
									height={20}
								/>
								rizkymaulanaofficial6@gmail.com
							</Link>
						</div>
					</div>
				</div>
				<p className="mx-auto mt-[60px] text-[#A0A0AC] text-sm z-10">
					All Rights Reserved. Copyright Rizky Maulana 2025.
				</p>
			</footer>
		</>
	);
